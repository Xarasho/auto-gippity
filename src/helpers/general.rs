...
const CODE_TEMPLATE_PATH: &str =
    "/home/alexx/Workspace/rust/rust_autogpt/web_template/src/web_template.rs";

const EXEC_MAIN_PATH: &str = "/home/alexx/Workspace/rust/rust_autogpt/web_template/src/main.rs";

const API_SCHEMA_PATH: &str =
    "/home/alexx/Workspace/rust/rust_autogpt/auto_gippity/schemas/api_schema.json";
...
// Check wheter request url is valid
...
pub fn save_backend_code(contents: &String) {
    ...
    fs::write(path, contents).expect("Failed to write main.rs to file")
}
...
mod tests {
    ...
    fn tests_extending_ai_function() {
        // let x_str: &str = convert_user_input_to_goal("dummy_variable");
        // dbg!(x_str);

        let extended_msg: Message =
            extend_ai_function(convert_user_input_to_goal, "dummy_variable");
        dbg!(&extended_msg);
